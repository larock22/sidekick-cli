...
from tinyagent.configuration.defaults import DEFAULT_USER_CONFIG
from tinyagent.configuration.models import ModelRegistry
from tinyagent.constants import APP_NAME, CONFIG_FILE_NAME, UI_COLORS
from tinyagent.core.setup.base import BaseSetup
from tinyagent.core.state import StateManager
from tinyagent.exceptions import ConfigurationError
from tinyagent.types import ConfigFile, ConfigPath, UserConfig
from tinyagent.ui import console as ui
from tinyagent.utils import system, user_configuration
from tinyagent.utils.text_utils import key_to_title
