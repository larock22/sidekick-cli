"""
Module: tinyagent.constants

Global constants and configuration values for the TinyAgent CLI application.
...
GUIDE_FILE_NAME = "TINYAGENT.md"
ENV_FILE = ".env"
CONFIG_FILE_NAME = "tinyagent.json"
...
UNDO_INITIAL_COMMIT = "Initial commit for tinyagent undo history"
UNDO_GIT_TIMEOUT = "Git initialization timed out"

# Log/status messages
MSG_UPDATE_AVAILABLE = "Update available: v{latest_version}"
MSG_UPDATE_INSTRUCTION = "Exit, and run: [bold]pip install --upgrade tinyagent-cli"
MSG_VERSION_DISPLAY = "TinyAgent CLI {version}"
