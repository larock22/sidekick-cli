...
from tinyagent.core.agents import main as agent
from tinyagent.core.agents.main import patch_tool_messages
from tinyagent.core.tool_handler import ToolHandler
from tinyagent.exceptions import AgentError, UserAbortError, ValidationError
from tinyagent.ui import console as ui
from tinyagent.ui.tool_ui import ToolUI
...
async def process_request(text: str, state_manager: StateManager, output: bool = True):
    ...
    try:
        ...
        try:
            from tinyagent.utils.text_utils import expand_file_refs
