"""
Module: tinyagent.setup

Package setup and metadata configuration for the TinyAgent CLI.
Provides high-level setup functions for initializing the application and its agents.
"""

from typing import Any, Optional

from tinyagent.core.setup import (AgentSetup, ConfigSetup, EnvironmentSetup, SetupCoordinator,
...
async def setup(run_setup: bool, state_manager: StateManager) -> None:
    """
    Setup TinyAgent on startup using the new setup coordinator.
